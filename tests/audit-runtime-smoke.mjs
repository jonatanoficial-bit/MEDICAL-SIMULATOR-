...
const appElement={innerHTML:'',classList,append(){},querySelector(){return null;}};
const body={innerHTML:'',classList,append(){},appendChild(){}};
const documentStub={
  readyState:'loading',fullscreenElement:null,
  documentElement:{lang:'pt-BR',requestFullscreen:()=>Promise.resolve()},body,
...
Object.defineProperty(globalThis,'navigator',{value:{userAgent:'ValeRuntimeAudit/1.0',language:'pt-BR',onLine:true},configurable:true});
...
if(!appElement.innerHTML.includes('v0.12.0'))throw new Error('Build visível ausente.');
...
console.log(JSON.stringify({ok:true,initialScreen:'setup',contentMode:globalThis.VALE_CONTENT_STATUS.mode,cases:globalThis.VALE_CONTENT_STATUS.caseCount,screens},null,2));
