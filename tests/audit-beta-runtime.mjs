...
const beta=createBetaObservability({key:'audit-beta',build:'v0.27.0',maxSessions:3,storage});
...
const audit=runBetaSelfTests({build:{version:'0.27.0',label:'v0.27.0',contentSchema:12},state,contentStatus:{caseCount:6,mode:'external'},governanceSummary:{ready:false,blockedCount:6},stateStore:{inspect:()=>({main:{exists:false,ok:false},backups:[]})},diagnostics:{summary:()=>({errors:0})},pwaStatus:{registered:false},documentRef:{documentElement:{style:{touchAction:'pan-y pinch-zoom'}}}});
