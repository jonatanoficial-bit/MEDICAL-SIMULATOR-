export function createDefaultState({buildVersion='0.15.0'}={}){
  return {
    meta:{saveSchema:6,buildVersion,contentMode:'fallback',updatedAt:null,lastHealthyAt:null,recoveryCount:0},
    ...
    ui:{shiftTab:'summary',recordTab:'overview',resultsOpen:false,closureReview:false,compactProfile:true},pwa:{installDismissed:false,lastInstallResult:null},
