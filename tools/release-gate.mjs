...
const releaseReady=gate.ready&&academy.publishable===true&&physiologyReady&&assessmentReady&&therapeuticsReady&&emergencyReady&&outpatientReady&&branchingReady;
const report={
...
fs.writeFileSync(path.join(root,'docs','release-gate-v0.24.0.json'),JSON.stringify(report,null,2)+'\n');
if(!releaseReady){
