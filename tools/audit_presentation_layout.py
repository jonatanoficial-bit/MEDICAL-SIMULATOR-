...
(ROOT/'docs/audit-presentation-layout-v2.0.0.json').write_text(json.dumps({'ok':all(v for k,v in checks.items() if k!='slots') and checks['slots']>=6,'checks':checks},ensure_ascii=False,indent=2)+'\n',encoding='utf-8')
