...
(function(){
  window.VALE_BUILD_LABEL = 'v2.0.0 | build 2026-06-17 10:43:42 BRT';
  ...
  function ensureBuildBadge(){
    ...
    b.className='build';
    b.textContent='v2.0.0 | build 2026-06-17 10:43:42 BRT';
...
(function(){
  ...
  window.ValeReleaseCandidate = {
    version: '0.9.0',
    build: 'v2.0.0 | build 2026-06-17 10:43:42 BRT',
    safeMode: true,
    exportSave: function(){
      try {
        var payload = {};
...
(function(){
  ...
  function addLog(type, detail){
    try {
      var log = readLog();
      log.push({type:type, detail:String(detail||''), at:new Date().toISOString(), build:'v2.0.0 | build 2026-06-17 10:43:42 BRT', width:innerWidth, height:innerHeight});
      writeLog(log);
    } catch(e) {}
  }
  window.ValeDiagnostics = {
    ...
    export:function(){
      try {
        var payload = {build:'v2.0.0 | build 2026-06-17 10:43:42 BRT', diagnostics:readLog()};
        var blob = new Blob([JSON.stringify(payload,null,2)], {type:'application/json'});
        var a = document.createElement('a');
        a.href = URL.createObjectURL(blob);
